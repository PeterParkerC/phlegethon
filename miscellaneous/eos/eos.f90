...
subroutine load_table_pxvar(path_to_table, &
                      NRHO,NT,NX, &
                      LOGRHOMIN,LOGRHOMAX,LOGTMIN,LOGTMAX,XMIN,XMAX, &
                      table_var,table_rho,table_T,table_X,table_drho,table_dT,table_dX)
  implicit none
  ...
  table_dX = (XMAX-XMIN)/real(NX-1)
  
  do iX=1,NX
   
    table_X(iX) = XMIN+real(iX-1)*table_dX
    ...
    do j=1,NT
     ...
     do i=1,NRHO
       ...
       read(21) &
       table_var(iX,id_f,i,j), &
       table_var(iX,id_dfdrho,i,j), &
       table_var(iX,id_dfdT,i,j), &
       table_var(iX,id_d2fdrho2,i,j), &
       table_var(iX,id_d2fdT2,i,j), &
       table_var(iX,id_d2fdrhodT,i,j), &
       table_var(iX,id_d3fdrho2dT,i,j), &
       table_var(iX,id_d3fdrhodT2,i,j), &
       table_var(iX,id_d4fdrho2dT2,i,j)
    ...
    do j=1,NT
     do i=1,NRHO
       ...
       read(21) &
       table_var(iX,id_c,i,j), &
       table_var(iX,id_dcdrho,i,j), &
       table_var(iX,id_dcdT,i,j), &
       table_var(iX,id_d2cdrhodT,i,j)
...
end subroutine load_table_pxvar

subroutine rhoT_given_3d_pxvar(rho_arr,T_arr,X_arr, &
                         radiation, & 
                         table, &
  ...
  double precision :: rho,T,Xs
  double precision :: T2,T3,T4
  double precision :: tmp

  double precision :: Prad, dPrad_dT, Erad, dErad_drho, dErad_dT, srad, dsrad_drho, dsrad_dT
  double precision :: Pp, Ep, dEp_drho, dEp_dT, sp, dsp_drho, dsp_dT, dPp_drho, dPp_dT
  
  double precision :: P,dPdrho,dPdT

  integer :: dummy

  integer :: n1,n2,n3,nnx 
  ...
  double precision :: f,rhos,Ye
  double precision :: zz,chiT,chirho,gam1,z,cv,sound
  ...
  double precision :: Xss,omega,omomega,mu
  ...
  do k=1,n3
   do j=1,n2
    do i=1,n1
      ...
      if(Xss<table_X(1)) Xss = table_X(1)
      if(Xss>table_X(nnx)) Xss = table_X(nnx)
     
      xh = int((Xss-table_X(1))/table_dX) + 1
      ...
      if(xh==nnx) then
       ...
       xh1 = xh
       xh2 = xh+1
       omega = (Xs-table_X(xh1))/(table_X(xh2)-table_X(xh1))
      endif
     
      omomega = 1.0d0-omega

      loc1_eos1 = table(xh1,1,ih,jh)
      loc1_eos2 = table(xh1,1,ih+1,jh)
      loc1_eos3 = table(xh1,1,ih,jh+1)
      loc1_eos4 = table(xh1,1,ih+1,jh+1)
      loc1_eos5 = table(xh1,2,ih,jh)
      loc1_eos6 = table(xh1,2,ih+1,jh)
      loc1_eos7 = table(xh1,2,ih,jh+1)
      loc1_eos8 = table(xh1,2,ih+1,jh+1)
      loc1_eos9 = table(xh1,3,ih,jh)
      loc1_eos10 = table(xh1,3,ih+1,jh)
      loc1_eos11 = table(xh1,3,ih,jh+1)
      loc1_eos12 = table(xh1,3,ih+1,jh+1)
      loc1_eos13 = table(xh1,4,ih,jh)
      loc1_eos14 = table(xh1,4,ih+1,jh)
      loc1_eos15 = table(xh1,4,ih,jh+1)
      loc1_eos16 = table(xh1,4,ih+1,jh+1)
      loc1_eos17 = table(xh1,5,ih,jh)
      loc1_eos18 = table(xh1,5,ih+1,jh)
      loc1_eos19 = table(xh1,5,ih,jh+1)
      loc1_eos20 = table(xh1,5,ih+1,jh+1)
      loc1_eos21 = table(xh1,6,ih,jh)
      loc1_eos22 = table(xh1,6,ih+1,jh)
      loc1_eos23 = table(xh1,6,ih,jh+1)
      loc1_eos24 = table(xh1,6,ih+1,jh+1)
      loc1_eos25 = table(xh1,7,ih,jh)
      loc1_eos26 = table(xh1,7,ih+1,jh)
      loc1_eos27 = table(xh1,7,ih,jh+1)
      loc1_eos28 = table(xh1,7,ih+1,jh+1)
      loc1_eos29 = table(xh1,8,ih,jh)
      loc1_eos30 = table(xh1,8,ih+1,jh)
      loc1_eos31 = table(xh1,8,ih,jh+1)
      loc1_eos32 = table(xh1,8,ih+1,jh+1)
      loc1_eos33 = table(xh1,9,ih,jh)
      loc1_eos34 = table(xh1,9,ih+1,jh)
      loc1_eos35 = table(xh1,9,ih,jh+1)
      loc1_eos36 = table(xh1,9,ih+1,jh+1)
 
      loc2_eos1 = table(xh2,1,ih,jh)
      loc2_eos2 = table(xh2,1,ih+1,jh)
      loc2_eos3 = table(xh2,1,ih,jh+1)
      loc2_eos4 = table(xh2,1,ih+1,jh+1)
      loc2_eos5 = table(xh2,2,ih,jh)
      loc2_eos6 = table(xh2,2,ih+1,jh)
      loc2_eos7 = table(xh2,2,ih,jh+1)
      loc2_eos8 = table(xh2,2,ih+1,jh+1)
      loc2_eos9 = table(xh2,3,ih,jh)
      loc2_eos10 = table(xh2,3,ih+1,jh)
      loc2_eos11 = table(xh2,3,ih,jh+1)
      loc2_eos12 = table(xh2,3,ih+1,jh+1)
      loc2_eos13 = table(xh2,4,ih,jh)
      loc2_eos14 = table(xh2,4,ih+1,jh)
      loc2_eos15 = table(xh2,4,ih,jh+1)
      loc2_eos16 = table(xh2,4,ih+1,jh+1)
      loc2_eos17 = table(xh2,5,ih,jh)
      loc2_eos18 = table(xh2,5,ih+1,jh)
      loc2_eos19 = table(xh2,5,ih,jh+1)
      loc2_eos20 = table(xh2,5,ih+1,jh+1)
      loc2_eos21 = table(xh2,6,ih,jh)
      loc2_eos22 = table(xh2,6,ih+1,jh)
      loc2_eos23 = table(xh2,6,ih,jh+1)
      loc2_eos24 = table(xh2,6,ih+1,jh+1)
      loc2_eos25 = table(xh2,7,ih,jh)
      loc2_eos26 = table(xh2,7,ih+1,jh)
      loc2_eos27 = table(xh2,7,ih,jh+1)
      loc2_eos28 = table(xh2,7,ih+1,jh+1)
      loc2_eos29 = table(xh2,8,ih,jh)
      loc2_eos30 = table(xh2,8,ih+1,jh)
      loc2_eos31 = table(xh2,8,ih,jh+1)
      loc2_eos32 = table(xh2,8,ih+1,jh+1)
      loc2_eos33 = table(xh2,9,ih,jh)
      loc2_eos34 = table(xh2,9,ih+1,jh)
      loc2_eos35 = table(xh2,9,ih,jh+1)
      loc2_eos36 = table(xh2,9,ih+1,jh+1)
      ...
      loc1_eos1 = table(xh1,10,ih,jh)
      loc1_eos2 = table(xh1,10,ih+1,jh)
      loc1_eos3 = table(xh1,10,ih,jh+1)
      loc1_eos4 = table(xh1,10,ih+1,jh+1)
      loc1_eos5 = table(xh1,11,ih,jh)
      loc1_eos6 = table(xh1,11,ih+1,jh)
      loc1_eos7 = table(xh1,11,ih,jh+1)
      loc1_eos8 = table(xh1,11,ih+1,jh+1)
      loc1_eos9 = table(xh1,12,ih,jh)
      loc1_eos10 = table(xh1,12,ih+1,jh)
      loc1_eos11 = table(xh1,12,ih,jh+1)
      loc1_eos12 = table(xh1,12,ih+1,jh+1)
      loc1_eos13 = table(xh1,13,ih,jh)
      loc1_eos14 = table(xh1,13,ih+1,jh)
      loc1_eos15 = table(xh1,13,ih,jh+1)
      loc1_eos16 = table(xh1,13,ih+1,jh+1)
     
      loc2_eos1 = table(xh2,10,ih,jh)
      loc2_eos2 = table(xh2,10,ih+1,jh)
      loc2_eos3 = table(xh2,10,ih,jh+1)
      loc2_eos4 = table(xh2,10,ih+1,jh+1)
      loc2_eos5 = table(xh2,11,ih,jh)
      loc2_eos6 = table(xh2,11,ih+1,jh)
      loc2_eos7 = table(xh2,11,ih,jh+1)
      loc2_eos8 = table(xh2,11,ih+1,jh+1)
      loc2_eos9 = table(xh2,12,ih,jh)
      loc2_eos10 = table(xh2,12,ih+1,jh)
      loc2_eos11 = table(xh2,12,ih,jh+1)
      loc2_eos12 = table(xh2,12,ih+1,jh+1)
      loc2_eos13 = table(xh2,13,ih,jh)
      loc2_eos14 = table(xh2,13,ih+1,jh)
      loc2_eos15 = table(xh2,13,ih,jh+1)
      loc2_eos16 = table(xh2,13,ih+1,jh+1)
      ...
      dPp_drho = Ye*dPp_drho

      tmp = rhos*rhos
      Pp = tmp*df_drho
      dPp_dT = tmp*df_drhodT
      sp = -Ye*df_dT
      dsp_dT = -Ye*df_dT2
      tmp = Ye*Ye
      dsp_drho = -df_drhodT*tmp
      Ep = Ye*f + T*sp
      dEp_dT = T*dsp_dT
      dEp_drho = df_drho*tmp + T*dsp_drho
    
      eos_arr(id_P,i,j,k) = eos_arr(id_P,i,j,k) + Pp
      eos_arr(id_E,i,j,k) = eos_arr(id_E,i,j,k) + Ep
      eos_arr(id_dPdrho,i,j,k) = eos_arr(id_dPdrho,i,j,k) + dPp_drho
      eos_arr(id_dPdT,i,j,k) = eos_arr(id_dPdT,i,j,k) + dPp_dT
      eos_arr(id_dEdrho,i,j,k) = eos_arr(id_dEdrho,i,j,k) + dEp_drho
      eos_arr(id_dEdT,i,j,k) = eos_arr(id_dEdT,i,j,k) + dEp_dT

      eos_arr(id_s,i,j,k) = eos_arr(id_s,i,j,k) + sp
      eos_arr(id_dsdrho,i,j,k) = eos_arr(id_dsdrho,i,j,k) + dsp_drho
      eos_arr(id_dsdT,i,j,k) = eos_arr(id_dsdT,i,j,k) + dsp_dT
 
      mu = CONST_RGAS*T*rho/Pp

      eos_arr(id_dPdA,i,j,k) = eos_arr(id_dPdA,i,j,k) - Pp/mu
  ...
  do k=1,n3
   do j=1,n2
    do i=1,n1
     ...
     if(radiation) then
      mu = CONST_RGAS*T*rho/(P-CONST_RAD*T**4/3.0d0)
     else
      mu = CONST_RGAS*T*rho/P
     endif
     ...
     eos_arr(id_phi,i,j,k) = -mu/rho*eos_arr(id_dPdA,i,j,k)/dPdrho
